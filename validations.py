...
def is_valid_data(city, temperature, humidity, weather_condition, visibility):
    ...
    if temperature is None:
        ...
        logger.warning(f"Invalid temperature type for {city}, should be a float or integer ")
        valid=False
    ...
    if humidity is None:
        ...
        logger.warning(f"Invalid humidity type for {city}, should be an integer ")
        valid=False
    ...
    if not weather_condition:
       ...
       logger.warning(f"Invalid weather condition type for {city}, should be a string")
       valid=False 
    ...
    if visibility is None:
        ...
        logger.warning(f"Invalid visibility type for {city}, should be an integer ")
        valid=False
    elif visibility<0 or visibility>10000: #The maximum value of the visibility is 10 km- from the openweather site
